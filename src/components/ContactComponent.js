...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email){
        ...
        if (this.state.touched.firstname && firstname.length < 3)
            ...
            errors.firstname = 'First Name should have less than 10 characters.';
        
        if (this.state.touched.lastname && lastname.length < 3)
            errors.lastname = 'Last Name should have at least 3 characters.';
        else if (this.state.touched.lastname && lastname.length > 10)
            errors.lastname = 'Last Name should have less than 10 characters.';
        ...
        if (this.state.touched.email && email.split('').filter(x=> x==='@').length !== 1)
            errors.email = 'email should contain a @ sysmbol';
                    ...
                    <div className='col-12 col-md-9'>
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type='textarea' id='message' name='message' placeholder='Your Feedback' rows="12" 
