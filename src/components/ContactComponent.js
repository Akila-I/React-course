...
class Contact extends Component {
    ...
    handleSubmit(values){
        console.log('Current State is: ' + JSON.stringify(values)); //works
                    ...
                    <div className='col-12 col-md-9'>
                        <Form model="feedback" onSubmit={(values)=>this.handleSubmit(values)}>
                            ...
                            <Row className='form-group'>
                                ...
                                <Col md={10}>
                                    <Control.text model='.telnum' id='telnum' name='telnum' placeholder='Contact Tel.' 
